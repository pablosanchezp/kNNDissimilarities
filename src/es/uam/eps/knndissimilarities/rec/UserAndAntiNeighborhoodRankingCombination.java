 ...
 * @param <I>
 */
public class UserAndAntiNeighborhoodRankingCombination<U,I> extends AbstractFastRecommender<U, I>{
	...
	public UserAndAntiNeighborhoodRankingCombination(FastPreferenceData<U, I> data, UserNeighborhood<U> positiveNeighborhood, UserNeighborhood<U> negativeNeighborhood, int q, String normalizer, String combiner) {
		super(data, data);
		System.out.println("UserAndAntiNeighborhoodRankingCombination + Fix bug");
